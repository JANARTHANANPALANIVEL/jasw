...
def generate_testcase(url):
    prompt = f"""
        You are an expert QA engineer. Generate a robust Selenium test script in Python with the below requirments to test the website: {url}.

        Requirements:
        1. use webscraping to analysis the website and Check page load and all functionality by analyzing the website.
        2. Highlight each tested element with a 1px solid red border.
        3. Wait 0.5 seconds after interacting with each element.
        ...
        6. Test the functionality of all interactive elements (like :  buttons, forms, links).
